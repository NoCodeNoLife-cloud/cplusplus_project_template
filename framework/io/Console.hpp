...
namespace framework::io {
    ...
    template <typename... Args>
    auto Console::format(const std::string& fmt, Args... args) -> void { std::cout << std::vformat(fmt, std::make_format_args(args...)); }

    template <typename... Args>
    auto Console::printf(const std::string& fmt, Args... args) -> void { format(fmt, args...); }
