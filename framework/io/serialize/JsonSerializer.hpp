...
class JsonSerializer abstract
{
  public:
    ...
    template <DerivedFromJsonSerializable T> static auto saveObjectToJsonFile(const T &entity, const std::string &filename) -> void;

    template <DerivedFromJsonSerializable T> static auto loadObjectFromJsonFile(const std::string &filename) -> T;
...
template <DerivedFromJsonSerializable T> auto JsonSerializer::saveObjectToJsonFile(const T &entity, const std::string &filename) -> void
{
...
template <DerivedFromJsonSerializable T> auto JsonSerializer::loadObjectFromJsonFile(const std::string &filename) -> T
{
    T entity{};
