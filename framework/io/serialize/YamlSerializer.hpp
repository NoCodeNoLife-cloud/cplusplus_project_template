...
template <typename T> class YamlSerializer abstract
{
  public:
...
template <typename T> void YamlSerializer<T>::serialize(const T &obj, const std::string &filename)
{
...
template <typename T> T YamlSerializer<T>::deserialize(const std::string &filename)
{
