...
template <> struct std::formatter<framework::entity::base_type::Character>
{
    ...
    static auto format(const framework::entity::base_type::Character &content, format_context &ctx) -> back_insert_iterator<_Fmt_buffer<char>>
    {
