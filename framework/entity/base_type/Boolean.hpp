...
template <> struct std::formatter<framework::entity::base_type::Boolean>
{
    ...
    static auto format(const framework::entity::base_type::Boolean &content, format_context &ctx) -> back_insert_iterator<_Fmt_buffer<char>>
    {
