...
{
    return most_significant_bits_ == other.most_significant_bits_ && least_significant_bits_ == other.least_significant_bits_;
}
...
{
    return static_cast<int32_t>(most_significant_bits_ >> 32 ^ most_significant_bits_ ^ least_significant_bits_ >> 32 ^ least_significant_bits_);
}
