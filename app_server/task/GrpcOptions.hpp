...
inline auto GrpcOptions::maxConnectionIdleMs() const -> int32_t { return max_connection_idle_ms_; }
inline auto GrpcOptions::maxConnectionAgeMs() const -> int32_t { return max_connection_age_ms_; }
inline auto GrpcOptions::maxConnectionAgeGraceMs() const -> int32_t { return max_connection_age_grace_ms_; }
inline auto GrpcOptions::keepaliveTimeMs() const -> int32_t { return keepalive_time_ms_; }
inline auto GrpcOptions::keepaliveTimeoutMs() const -> int32_t { return keepalive_timeout_ms_; }
inline auto GrpcOptions::keepalivePermitWithoutCalls() const -> int32_t { return keepalive_permit_without_calls_; }
inline auto GrpcOptions::maxConnectionIdleMs(const int32_t value) -> void { max_connection_idle_ms_ = value; }
inline auto GrpcOptions::maxConnectionAgeMs(const int32_t value) -> void { max_connection_age_ms_ = value; }
inline auto GrpcOptions::maxConnectionAgeGraceMs(const int32_t value) -> void { max_connection_age_grace_ms_ = value; }
inline auto GrpcOptions::keepaliveTimeMs(const int32_t value) -> void { keepalive_time_ms_ = value; }
inline auto GrpcOptions::keepaliveTimeoutMs(const int32_t value) -> void { keepalive_timeout_ms_ = value; }
inline auto GrpcOptions::keepalivePermitWithoutCalls(const int32_t value) -> void { keepalive_permit_without_calls_ = value; }
}  // namespace app_server
