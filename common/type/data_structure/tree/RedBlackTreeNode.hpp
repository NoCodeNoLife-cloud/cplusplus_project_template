...
template <typename T> RedBlackTreeNode<T>::RedBlackTreeNode(const T &value) : data_(value), color_(Color::Red)
{
}
...
template <typename T> auto RedBlackTreeNode<T>::setLeft(std::shared_ptr<RedBlackTreeNode> node) -> void
{
    left_ = node;
}
...
template <typename T> auto RedBlackTreeNode<T>::setRight(std::shared_ptr<RedBlackTreeNode> node) -> void
{
    right_ = node;
}
...
template <typename T> auto RedBlackTreeNode<T>::setParent(std::shared_ptr<RedBlackTreeNode> node) -> void
{
    parent_ = node;
}

template <typename T> auto RedBlackTreeNode<T>::getColor() const -> Color
{
    return color_;
}

template <typename T> auto RedBlackTreeNode<T>::setColor(const Color c) -> void
{
    color_ = c;
}
} // namespace fox
