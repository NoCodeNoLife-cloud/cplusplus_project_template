...
class Point3D {
 public:
  ...
  Point3D(double xVal, double yVal, double zVal) : x_(xVal), y_(yVal), z_(zVal) {}
  ...
  auto setX(double xVal) -> void { x_ = xVal; }

  /// @brief Set the Y coordinate
  /// @param yVal New Y coordinate value
  auto setY(double yVal) -> void { y_ = yVal; }

  /// @brief Set the Z coordinate
  /// @param zVal New Z coordinate value
  auto setZ(double zVal) -> void { z_ = zVal; }
