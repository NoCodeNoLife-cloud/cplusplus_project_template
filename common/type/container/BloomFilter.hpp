...
class BloomFilter final
{
  ...
  public:
    ...
    template <typename T> auto insert(const T &t) -> void
    {
    ...
    template <typename InputIterator> auto insert(InputIterator begin, InputIterator end) -> void
    {
    ...
    /// @return True if the key is present, false otherwise.
    template <typename T> auto contains(const T &t) const -> bool
    {
    ...
    template <typename InputIterator> auto contains_all(InputIterator begin, InputIterator end) const -> InputIterator
    {
        InputIterator itr = begin;
    ...
    template <typename InputIterator> auto contains_none(InputIterator begin, InputIterator end) const -> InputIterator
    {
        InputIterator itr = begin;
