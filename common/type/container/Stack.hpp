...
template <typename T, typename Container> Stack<T, Container>::Stack() = default;
...
template <typename T, typename Container> auto Stack<T, Container>::push(const T &value) -> void
{
    data.push_back(value);
}

template <typename T, typename Container> auto Stack<T, Container>::push(T &&value) -> void
{
...
template <typename T, typename Container> auto Stack<T, Container>::pop() -> void
{
    if (data.empty())
    {
...
template <typename T, typename Container> auto Stack<T, Container>::top() const -> const T &
{
    if (data.empty())
    {
        throw std::out_of_range("Stack is empty");
...
template <typename T, typename Container> auto Stack<T, Container>::top() -> T &
{
    if (data.empty())
    {
        throw std::out_of_range("Stack is empty");
...
template <typename T, typename Container> auto Stack<T, Container>::empty() const -> bool
{
    return data.empty();
}

template <typename T, typename Container> auto Stack<T, Container>::size() const -> size_t
{
    return data.size();
}
} // namespace fox
