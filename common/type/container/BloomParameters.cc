...
auto BloomParameters::operator!() const -> bool { return minimum_size > maximum_size || minimum_number_of_hashes > maximum_number_of_hashes || minimum_number_of_hashes < 1 || 0 == maximum_number_of_hashes || 0 == projected_element_count || false_positive_probability < 0.0 || std::numeric_limits<double>::infinity() == std::abs(false_positive_probability) || 0 == random_seed || 0xFFFFFFFFFFFFFFFFULL == random_seed; }

BloomParameters::optimal_parameters_t::optimal_parameters_t() : number_of_hashes(0), table_size(0) {}
