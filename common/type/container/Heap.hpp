...
template <typename T, typename Compare = std::less<T>> class Heap
{
  public:
    Heap();
    template <typename Iterator> Heap(Iterator begin, Iterator end);
...
template <typename T, typename Compare> Heap<T, Compare>::Heap() = default;
...
template <typename T, typename Compare> auto Heap<T, Compare>::push(const T &value) -> void
{
    data_.push_back(value);
    heapify_up(data_.size() - 1);
}

template <typename T, typename Compare> auto Heap<T, Compare>::push(T &&value) -> void
{
...
template <typename T, typename Compare> auto Heap<T, Compare>::pop() -> void
{
    if (data_.empty())
    {
...
template <typename T, typename Compare> auto Heap<T, Compare>::top() const -> const T &
{
    if (data_.empty())
    {
        throw std::out_of_range("Heap is empty");
...
template <typename T, typename Compare> auto Heap<T, Compare>::top() -> T &
{
    if (data_.empty())
    {
        throw std::out_of_range("Heap is empty");
...
template <typename T, typename Compare> auto Heap<T, Compare>::size() const -> size_t
{
    return data_.size();
}

template <typename T, typename Compare> auto Heap<T, Compare>::empty() const -> bool
{
    return data_.empty();
}

template <typename T, typename Compare> auto Heap<T, Compare>::heapify() -> void
{
...
template <typename T, typename Compare> auto Heap<T, Compare>::heapify_up(size_t index) -> void
{
    while (index > 0)
    {
...
template <typename T, typename Compare> auto Heap<T, Compare>::heapify_down(size_t index) -> void
{
