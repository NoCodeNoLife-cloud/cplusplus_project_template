...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] auto operator+(const BigInteger& other) const noexcept
            -> BigInteger;
        ...
        [[nodiscard]] auto operator/(const BigInteger& other) const
            -> BigInteger;
        ...
        /// @return The resulting BigInteger
        [[nodiscard]] static auto fromInt(int64_t num) noexcept
            -> BigInteger;
