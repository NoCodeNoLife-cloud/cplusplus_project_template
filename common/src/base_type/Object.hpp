...
namespace common
{
    ...
    public:
        ...
        template<typename T>
        [[nodiscard]] auto instanceOf() const noexcept
            -> bool
        {
        ...
        [[nodiscard]] auto isInstance(const std::type_info& target_type) const noexcept
            -> bool;

        /// @brief Gets the class name as a string.
        /// @return std::string The name of the class.
        [[nodiscard]] auto getClassName() const
            -> std::string;
        ...
        [[nodiscard]] auto is(const Object& other) const noexcept
            -> bool;
