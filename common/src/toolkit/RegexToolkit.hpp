...
namespace common
{
    ...
    public:
        ...
        static auto is_match(const std::string& text, const std::string& pattern,
        ...
        /// @throws std::invalid_argument if the pattern is invalid
        static auto is_search(const std::string& text, const std::string& pattern,
        ...
        /// @throws std::invalid_argument if the pattern is invalid
        static auto get_matches(const std::string& text, const std::string& pattern,
                                std::regex_constants::syntax_option_type flags = std::regex_constants::ECMAScript) ->
        ...
        /// @throws std::invalid_argument if the pattern is invalid
        static auto get_matches_with_groups(const std::string& text, const std::string& pattern,
                                            std::regex_constants::syntax_option_type flags =
                                                std::regex_constants::ECMAScript) -> std::vector<std::vector<
            std::string>>;
        ...
        /// @throws std::invalid_argument if the pattern is invalid
        static auto replace_all(const std::string& text, const std::string& pattern, const std::string& replacement,
                                std::regex_constants::syntax_option_type flags = std::regex_constants::ECMAScript) ->
            std::string;
        ...
        /// @throws std::invalid_argument if the pattern is invalid
        static auto split(const std::string& text, const std::string& pattern,
                          std::regex_constants::syntax_option_type flags = std::regex_constants::ECMAScript) ->
            std::vector<std::string>;
    };
}
