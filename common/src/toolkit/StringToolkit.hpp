...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] static auto split(const std::string& target, char split_char) noexcept -> std::vector<std::string>;
        ...
        [[nodiscard]] static auto concatenate(const std::vector<std::string>& source, char split_char) noexcept -> std::string;
    };
}
