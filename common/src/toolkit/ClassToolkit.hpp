...
namespace common
{
    ...
    public:
        ...
        template <typename T>
        [[nodiscard]] static auto getTypeId(const T& /*t*/) noexcept
            -> std::string;
        ...
        template <typename T>
        [[nodiscard]] static auto getTypeIdWithCvr(const T& /*t*/) noexcept
            -> std::string;
        ...
        /// @return std::string The pretty name of the type.
        template <typename T>
        [[nodiscard]] static auto getTypeIdByClass() noexcept
            -> std::string;
        ...
        /// @return std::string The pretty name of the type with CVR.
        template <typename T>
        [[nodiscard]] static auto getTypeIdWithCvrByClass() noexcept
            -> std::string;
        ...
        template <typename T>
        [[nodiscard]] static auto getFields(const T& obj)
    ...
    private:
        ...
        [[nodiscard]] static auto invokeHelper(const T& obj,
                                               M member)
            -> decltype(obj.*member);
