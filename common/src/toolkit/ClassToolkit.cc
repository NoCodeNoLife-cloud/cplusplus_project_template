...
{
    template <typename T>
    auto ClassToolkit::getTypeId(const T&) noexcept
        -> std::string
    {
    ...
    template <typename T>
    auto ClassToolkit::getTypeIdWithCvr(const T&) noexcept
        -> std::string
    {
    ...
    template <typename T>
    auto ClassToolkit::getTypeIdByClass() noexcept
        -> std::string
    {
        return boost::typeindex::type_id<T>().pretty_name();
    }
    ...
    template <typename T>
    auto ClassToolkit::getTypeIdWithCvrByClass() noexcept
        -> std::string
    {
        return boost::typeindex::type_id_with_cvr<T>().pretty_name();
    }
    ...
    template <typename T>
    auto ClassToolkit::getFields(const T& obj)
    ...
    auto ClassToolkit::invokeHelper(const T& obj,
                                    M member)
        -> decltype(obj.*member)
    {
        return obj.*member;
