...
namespace common
{
    ...
    public:
        ...
        auto operator=(AutoJoinThread&& other) noexcept
            -> AutoJoinThread&;
        ...
        explicit AutoJoinThread(Function&& f,
                                Args&&... args);
