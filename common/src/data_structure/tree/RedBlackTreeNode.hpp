...
namespace fox
{
    ...
    public:
        ...
        auto setData(const T& value) noexcept
            -> void;
        ...
        auto setLeft(std::shared_ptr<RedBlackTreeNode> node) noexcept
            -> void;
        ...
        auto setRight(std::shared_ptr<RedBlackTreeNode> node) noexcept
            -> void;
        ...
        auto setParent(std::shared_ptr<RedBlackTreeNode> node) noexcept
            -> void;
        ...
        auto setColor(Color c) noexcept
            -> void;
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::getData() const noexcept
        -> T
    {
        return data_;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::setData(const T& value) noexcept
        -> void
    {
        data_ = value;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::getLeft() const noexcept
        -> std::shared_ptr<RedBlackTreeNode>
    {
        return left_;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::setLeft(std::shared_ptr<RedBlackTreeNode> node) noexcept
        -> void
    {
        left_ = node;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::getRight() const noexcept
        -> std::shared_ptr<RedBlackTreeNode>
    {
        return right_;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::setRight(std::shared_ptr<RedBlackTreeNode> node) noexcept
        -> void
    {
        right_ = node;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::getParent() const noexcept
        -> std::shared_ptr<RedBlackTreeNode>
    {
        return parent_;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::setParent(std::shared_ptr<RedBlackTreeNode> node) noexcept
        -> void
    {
        parent_ = node;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::getColor() const noexcept
        -> Color
    {
        return color_;
    }
    ...
    template <typename T>
    auto RedBlackTreeNode<T>::setColor(const Color c) noexcept
        -> void
    {
        color_ = c;
    }
