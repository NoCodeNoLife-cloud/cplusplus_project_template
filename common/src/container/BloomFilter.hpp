...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] auto operator==(const BloomFilter& f) const noexcept
            -> bool;
        ...
        auto operator=(const BloomFilter& f)
            -> BloomFilter&;
        ...
        auto insert(const unsigned char* key_begin,
        ...
        auto insert(InputIterator begin,
                    InputIterator end)
            -> void;
        ...
        [[nodiscard]] auto contains(const unsigned char* key_begin,
        ...
        /// @return True if the key is present, false otherwise.
        [[nodiscard]] auto contains(const std::string& key) const
            -> bool;
        ...
        /// @param length Length of the key.
        /// @return True if the key is present, false otherwise.
        [[nodiscard]] auto contains(const char* data,
        ...
        template <typename InputIterator>
        [[nodiscard]] auto contains_all(InputIterator begin,
        ...
        template <typename InputIterator>
        [[nodiscard]] auto contains_none(InputIterator begin,
                                         InputIterator end) const
            -> InputIterator;
        ...
        [[nodiscard]] auto hash_count() const noexcept
            -> std::size_t;
    ...
    protected:
        ...
        static auto hash_ap(const unsigned char* begin,
