...
namespace common
{
    auto OpenSSLToolkit::deriveKey(const std::string& password,
                                   unsigned char key[32],
                                   unsigned char salt[16]) noexcept
        -> void
    {
    ...
    auto OpenSSLToolkit::encryptAES256CBC(const std::string& plaintext,
    ...
    auto OpenSSLToolkit::decryptAES256CBC(const std::vector<unsigned char>& ciphertext,
                                          const std::string& password,
                                          unsigned char salt[16])
        -> std::string
    {
