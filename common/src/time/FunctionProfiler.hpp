...
namespace common
{
    ...
    public:
        ...
        explicit FunctionProfiler(std::string function_name,
        ...
        auto recordEnd(bool autoPrint = false) noexcept
            -> void;
        ...
        [[nodiscard]] auto getRunTimeMs() const
            -> double;
