...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] auto isAbsolute() const noexcept
            -> bool;

        /// @brief Creates a new file
        /// @return true if the file was created successfully, false otherwise
        [[nodiscard]] auto createNewFile() const
            -> bool;

        /// @brief Deletes the file
        /// @return true if the file was deleted successfully, false otherwise
        [[nodiscard]] auto deleteFile() const noexcept
            -> bool;

        /// @brief Renames the file to the destination file
        /// @param dest The destination file
        /// @return true if the file was renamed successfully, false otherwise
        [[nodiscard]] auto renameTo(const File& dest) const noexcept
            -> bool;

        /// @brief Copies the file to the destination path
        /// @param dest The destination file
        /// @return true if the file was copied successfully, false otherwise
        [[nodiscard]] auto copyTo(const File& dest) const
            -> bool;
        ...
        [[nodiscard]] auto lastModified() const noexcept
            -> int64_t;
        ...
        [[nodiscard]] auto getExtension() const noexcept
            -> std::string;
        ...
        [[nodiscard]] auto getParentFile() const
            -> File;
        ...
        static auto getFileMD5(const std::filesystem::path& filePath)
            -> std::string;
