...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] static auto read(const std::string& filepath)
            -> YAML::Node;
        ...
        static auto update(const std::string& filepath,
                           const YAML::Node& data)
            -> bool;
        ...
        static auto remove(const std::string& filepath)
            -> bool;
        ...
        [[nodiscard]] static auto getValue(const std::string& filepath,
        ...
        static auto setValue(const std::string& filepath,
                             const std::string& key,
        ...
        [[nodiscard]] static auto getNestedValue(const std::string& filepath,
        ...
        /// @param value The YAML node value to set.
        /// @return true if the value was set successfully, false otherwise.
        static auto setNestedValue(const std::string& filepath,
                                   const std::string& path,
                                   const YAML::Node& value)
            -> bool;
        ...
        [[nodiscard]] static auto hasKey(const std::string& filepath,
                                         const std::string& key)
            -> bool;
        ...
        static auto merge(const std::string& filepath,
                          const YAML::Node& data)
            -> bool;
        ...
        [[nodiscard]] static auto getNodeOrRoot(const YAML::Node& root,
                                                const std::string& path)
            -> YAML::Node;
    };
}
