...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] auto mkdir() const noexcept
            -> bool;
        ...
        [[nodiscard]] auto mkdirs(bool exist_ok = false) const
            -> bool;
        ...
        [[nodiscard]] auto isDirectory() const noexcept
            -> bool;
        ...
        [[nodiscard]] auto rename(const std::string& newName) const noexcept
            -> bool;
        ...
        [[nodiscard]] auto clearAll() const
            -> bool;

        /// @brief Get the current working directory
        /// @return The current working directory path
        [[nodiscard]] static auto getCurrentWorkingDirectory()
            -> std::filesystem::path;
