...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] auto getRowCount() const noexcept
            -> uint64_t;
        ...
        auto insertRow(uint64_t insertIndex,
