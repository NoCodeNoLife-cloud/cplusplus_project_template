...
namespace common
{
    ...
    public:
        ...
        virtual auto write(const std::string& str)
            -> void;
    ...
    inline auto AbstractWriter::append(const char c)
        -> AbstractWriter&
    {
        write(c);
        return *this;
    ...
    inline auto AbstractWriter::append(const std::string& csq)
        -> AbstractWriter&
    {
        write(csq);
        return *this;
    ...
    inline auto AbstractWriter::append(std::string_view str)
        -> AbstractWriter&
    {
        if (!str.empty())
        {
    ...
    inline auto AbstractWriter::append(const char* str)
        -> AbstractWriter&
    {
        if (str)
        {
    ...
    inline auto AbstractWriter::append(const std::initializer_list<char> chars)
        -> AbstractWriter&
    {
        if (!empty(chars))
        {
    ...
    inline auto AbstractWriter::append(const char* chars,
                                       const size_t count)
        -> AbstractWriter&
    {
        if (chars && count > 0)
    ...
    inline auto AbstractWriter::write(const char c)
        -> void
    {
    ...
    inline auto AbstractWriter::write(const std::vector<char>& cBuf)
        -> void
    {
        if (!cBuf.empty())
        {
    ...
    inline auto AbstractWriter::write(const std::string& str)
        -> void
    {
        if (!str.empty())
        {
