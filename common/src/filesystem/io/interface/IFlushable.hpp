...
namespace common
{
    ...
    public:
        ...
        virtual auto flushSafe() noexcept
            -> bool;
        ...
        [[nodiscard]] virtual auto isFlushNeeded() const
            -> bool;
    ...
    inline auto IFlushable::flushSafe() noexcept
        -> bool
    {
        try
        {
    ...
    inline auto IFlushable::isFlushNeeded() const
        -> bool
    {
