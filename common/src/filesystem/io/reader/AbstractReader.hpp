...
namespace common
{
    ...
    public:
        ...
        virtual auto read(std::vector<char>& cBuf,
                          size_t off,
                          size_t len)
            -> int = 0;
        ...
        [[nodiscard]] virtual auto markSupported() const
            -> bool;
        ...
        virtual auto mark(size_t readAheadLimit)
            -> void = 0;
        ...
        [[nodiscard]] virtual auto ready() const
            -> bool;
