...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] static auto getStringOrDefault(const rapidjson::Value& json, const char* key, const std::string& defaultValue) noexcept -> std::string;
        ...
        [[nodiscard]] static auto getIntOrDefault(const rapidjson::Value& json, const char* key, int32_t defaultValue) noexcept -> int32_t;
        ...
        [[nodiscard]] static auto getDoubleOrDefault(const rapidjson::Value& json, const char* key, double defaultValue) noexcept -> double;
        ...
        [[nodiscard]] static auto getBoolOrDefault(const rapidjson::Value& json, const char* key, bool defaultValue) noexcept -> bool;
        ...
        static auto serializeField(rapidjson::Writer<rapidjson::StringBuffer>& writer, const char* key, const std::string& value) noexcept -> void;

        /// @brief Serializes an integer field to JSON.
        /// @param writer The JSON writer to use for serialization.
        /// @param key The key for the field.
        /// @param value The integer value to serialize.
        static auto serializeField(rapidjson::Writer<rapidjson::StringBuffer>& writer, const char* key, int32_t value) noexcept -> void;

        /// @brief Serializes a double field to JSON.
        /// @param writer The JSON writer to use for serialization.
        /// @param key The key for the field.
        /// @param value The double value to serialize.
        static auto serializeField(rapidjson::Writer<rapidjson::StringBuffer>& writer, const char* key, double value) noexcept -> void;

        /// @brief Serializes a boolean field to JSON.
        /// @param writer The JSON writer to use for serialization.
        /// @param key The key for the field.
        /// @param value The boolean value to serialize.
        static auto serializeField(rapidjson::Writer<rapidjson::StringBuffer>& writer, const char* key, bool value) noexcept -> void;
    };
}
