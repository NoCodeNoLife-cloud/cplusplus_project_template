...
namespace common
{
    ...
    public:
        ...
        [[nodiscard]] static auto getStringOrDefault(const rapidjson::Value& json,
                                                     const char* key,
        ...
        [[nodiscard]] static auto getIntOrDefault(const rapidjson::Value& json,
                                                  const char* key,
        ...
        [[nodiscard]] static auto getDoubleOrDefault(const rapidjson::Value& json,
                                                     const char* key,
        ...
        [[nodiscard]] static auto getBoolOrDefault(const rapidjson::Value& json,
                                                   const char* key,
