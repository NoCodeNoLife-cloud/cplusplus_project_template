...
namespace common
{
    ...
    public:
        ...
        explicit UserCredentials(std::string username,
                                 std::string hashed_password,
                                 std::string salt) noexcept;

        /// @brief Get username
        /// @return Username string
        [[nodiscard]] auto get_username() const noexcept
            -> const std::string&;

        /// @brief Get hashed password
        /// @return Hashed password string
        [[nodiscard]] auto get_hashed_password() const noexcept
            -> const std::string&;

        /// @brief Get salt value
        /// @return Salt string used for hashing
        [[nodiscard]] auto get_salt() const noexcept
            -> const std::string&;

        /// @brief Get number of failed login attempts
        /// @return Count of failed attempts
        [[nodiscard]] auto get_failed_attempts() const noexcept
            -> size_t;

        /// @brief Increment failed login attempt counter
        auto increment_failed_attempts() noexcept
            -> void;

        /// @brief Reset failed attempt counter
        auto reset_failed_attempts() noexcept
            -> void;
        ...
        /// @return true if account is locked, false otherwise
        [[nodiscard]] auto is_locked(std::chrono::minutes lockout_duration,
