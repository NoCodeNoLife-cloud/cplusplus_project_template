...
namespace common
{
    ...
    auto PasswordPolicy::validate(const std::string& password) const noexcept
        -> bool
    {
    ...
    auto PasswordPolicy::is_uppercase_char(char c) noexcept
        -> bool
    {
        return std::isupper(static_cast<unsigned char>(c));
    }

    auto PasswordPolicy::is_lowercase_char(char c) noexcept
        -> bool
    {
        return std::islower(static_cast<unsigned char>(c));
    }

    auto PasswordPolicy::is_digit_char(char c) noexcept
        -> bool
    {
        return std::isdigit(static_cast<unsigned char>(c));
    }

    auto PasswordPolicy::is_special_char(char c) noexcept
        -> bool
    {
        return std::ispunct(static_cast<unsigned char>(c)) || std::isspace(static_cast<unsigned char>(c));
    }

    auto PasswordPolicy::set_min_length(const size_t length) noexcept
        -> void
    {
        min_length_ = length;
    }

    auto PasswordPolicy::set_max_length(const size_t length) noexcept
        -> void
    {
        max_length_ = length;
    }

    auto PasswordPolicy::set_require_uppercase(const bool require) noexcept
        -> void
    {
        require_uppercase_ = require;
    }

    auto PasswordPolicy::set_require_lowercase(const bool require) noexcept
        -> void
    {
        require_lowercase_ = require;
    }

    auto PasswordPolicy::set_require_digits(const bool require) noexcept
        -> void
    {
        require_digits_ = require;
    }

    auto PasswordPolicy::set_require_special(const bool require) noexcept
        -> void
    {
