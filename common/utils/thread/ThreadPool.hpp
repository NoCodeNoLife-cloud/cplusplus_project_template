...
namespace fox
{
    ...
    {
    public:
        ThreadPool(const size_t core_threads, const size_t max_threads, const size_t queue_size,
                   const std::chrono::milliseconds idle_time)
            : stop_(false), core_thread_count_(core_threads), max_thread_count_(max_threads),
