...
class File final {
 public:
  ...
  [[nodiscard]] auto deleteFile() const -> bool { return std::filesystem::remove(file_path_); }

  /// @brief Checks if the file exists
  /// @return true if the file exists, false otherwise
  [[nodiscard]] auto exists() const -> bool { return std::filesystem::exists(file_path_); }

  /// @brief Gets the absolute path of the file
  /// @return The absolute path as a string
  [[nodiscard]] auto getAbsolutePath() const -> std::string { return absolute(file_path_).string(); }

  /// @brief Gets the absolute file object
  /// @return A File object representing the absolute path
  [[nodiscard]] auto getAbsoluteFile() const -> File { return File(absolute(file_path_).string()); }

  /// @brief Gets the name of the file
  /// @return The file name as a string
  [[nodiscard]] auto getName() const -> std::string { return file_path_.filename().string(); }

  /// @brief Gets the parent directory path
  /// @return The parent directory path as a string
  [[nodiscard]] auto getParent() const -> std::string { return file_path_.parent_path().string(); }

  /// @brief Gets the parent directory as a File object
  /// @return A File object representing the parent directory
  [[nodiscard]] auto getParentFile() const -> File { return file_path_.has_parent_path() ? File(file_path_.parent_path()) : File(std::string("")); }

  /// @brief Gets the file path
  /// @return The file path as a string
  [[nodiscard]] auto getPath() const -> std::string { return file_path_.string(); }
  ...
  [[nodiscard]] auto hashCode() const -> size_t { return std::hash<std::string>()(file_path_.string()); }

  /// @brief Checks if the file path is absolute
  /// @return true if the path is absolute, false otherwise
  [[nodiscard]] auto isAbsolute() const -> bool { return file_path_.is_absolute(); }
  ...
  [[nodiscard]] auto isFile() const -> bool { return is_regular_file(file_path_); }
  ...
  [[nodiscard]] auto toURI() const -> std::string { return "file://" + file_path_.string(); }
