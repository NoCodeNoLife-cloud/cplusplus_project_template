...
class Directory {
 public:
  ...
  [[nodiscard]] auto exists() const -> bool { return std::filesystem::exists(dir_path_); }

  /// @brief Check if the path is a directory
  /// @return true if the path is a directory, false otherwise
  [[nodiscard]] auto isDirectory() const -> bool { return std::filesystem::is_directory(dir_path_); }

  /// @brief List directory contents
  /// @param recursive Whether to list subdirectories recursively
  /// @return A vector of directory entries
  [[nodiscard]] auto listDir(bool recursive) const -> std::vector<std::filesystem::directory_entry> { return listDir(dir_path_, recursive); }
  ...
  /// @param recursive Whether to list subdirectories recursively
  /// @return A vector of directory entries
  [[nodiscard]] auto listEntries(bool recursive = false) const -> std::vector<std::filesystem::directory_entry> { return listDir(dir_path_, recursive); }
  ...
  static auto getCurrentWorkingDirectory() -> std::filesystem::path { return std::filesystem::current_path(); }
