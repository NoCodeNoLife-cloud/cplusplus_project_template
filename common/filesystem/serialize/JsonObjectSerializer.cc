...
namespace common {
auto JsonObjectSerializer::getStringOrDefault(const rapidjson::Value& json,
                                              const char* key,
...
auto JsonObjectSerializer::getIntOrDefault(const rapidjson::Value& json,
                                           const char* key,
...
auto JsonObjectSerializer::getDoubleOrDefault(const rapidjson::Value& json,
                                              const char* key,
...
auto JsonObjectSerializer::getBoolOrDefault(const rapidjson::Value& json,
                                            const char* key,
...
auto JsonObjectSerializer::serializeField(
