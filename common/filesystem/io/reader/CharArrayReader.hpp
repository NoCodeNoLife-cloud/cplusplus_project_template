...
class CharArrayReader final : public AbstractReader {
 public:
  ...
  [[nodiscard]] auto ready() const -> bool override { return pos_ < count_; }
  ...
  auto mark(size_t readAheadLimit) -> void override { marked_pos_ = readAheadLimit; }

  /// @brief Resets the stream to the most recent mark.
  auto reset() -> void override { pos_ = marked_pos_; }
