...
StringWriter& StringWriter::append(const std::string& csq, const size_t start,
                                   const size_t end) {
...
void StringWriter::write(const std::string& str, const size_t off,
                         const size_t len) {
...
auto StringWriter::write(const std::vector<char>& cBuf, const size_t off,
