...
auto AbstractWriter::write(const std::vector<char>& cBuf) -> void { write(cBuf, 0, cBuf.size()); }

auto AbstractWriter::write(const std::string& str) -> void { write(str, 0, str.size()); }
