...
namespace common::net
{
    ...
    {
    public:
        explicit DatagramSocket(boost::asio::io_context& io_context): socket_(
        ...
        {
            const boost::asio::ip::udp::endpoint endpoint(boost::asio::ip::address::from_string(packet.host()),
                                                          packet.port());
