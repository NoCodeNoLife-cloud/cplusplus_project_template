...
inline auto YAML::convert<app_client::GrpcOptions>::decode(const Node& node, app_client::GrpcOptions& rhs) -> bool {
...
inline auto YAML::convert<app_client::GrpcOptions>::encode(const app_client::GrpcOptions& rhs) -> Node {
  Node node;
