...
namespace gtest_case {
  ...
  TEST(ArraysUtilTest, AsList_ConvertsStringArrayToVector) {
    ...
    const std::vector<std::string> result = ArraysUtil::asList(arr, 2);
  ...
  TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundAtBeginning) {
    int arr[] = {1, 3, 5, 7};
    ArraysUtil::sort(arr, 4);
    const int32_t result = ArraysUtil::binarySearch(arr, 4, 1);
    EXPECT_EQ(result, 0);
  }
  ...
  TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundInMiddle) {
    int arr[] = {1, 3, 5, 7};
    ArraysUtil::sort(arr, 4);
    const int32_t result = ArraysUtil::binarySearch(arr, 4, 5);
    EXPECT_EQ(result, 2);
  }
  ...
  TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundAtEnd) {
    int arr[] = {1, 3, 5, 7};
    ArraysUtil::sort(arr, 4);
    const int32_t result = ArraysUtil::binarySearch(arr, 4, 7);
    EXPECT_EQ(result, 3);
  }
  ...
  TEST(ArraysUtilTest, BinarySearch_ReturnsNegativeOneWhenElementNotFound) {
    int arr[] = {1, 3, 5, 7};
    ArraysUtil::sort(arr, 4);
    const int32_t result = ArraysUtil::binarySearch(arr, 4, 6);
    EXPECT_EQ(result, -1);
  }

  TEST(ArraysUtilTest, BinarySearchWithRange_ReturnsIndexWithinSpecifiedRange) {
    int arr[] = {1, 3, 5, 7, 9};
    ArraysUtil::sort(arr, 5);
    const int32_t result = ArraysUtil::binarySearch(arr, 1, 4, 7);
    EXPECT_EQ(result, 3);
  }
  ...
  TEST(ArraysUtilTest, Equals_ReturnsTrueForIdenticalArrays) {
    ...
    const bool result = ArraysUtil::equals(a, 3, b, 3);
    EXPECT_TRUE(result);
  }
  ...
  TEST(ArraysUtilTest, Equals_ReturnsFalseForDifferentLengths) {
    constexpr int a[] = {1, 2};
    constexpr int b[] = {1, 2, 3};
    const bool result = ArraysUtil::equals(a, 2, b, 3);
    EXPECT_FALSE(result);
  }
  ...
  TEST(ArraysUtilTest, ToString_ReturnsSingleElementString) {
    ...
    const std::string result = ArraysUtil::toString(arr, 1);
    EXPECT_EQ(result, "[42]");
  }
