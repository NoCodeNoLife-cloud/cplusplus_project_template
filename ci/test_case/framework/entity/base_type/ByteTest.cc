...
using framework::entity::base_type::Byte;
...
namespace gtest_case {
  ...
  TEST(ByteTest, EqualsComparesValuesCorrectly) {
    const Byte byte1(100);
    const Byte byte2(100);
    const Byte byte3(50);
  ...
  TEST(ByteTest, ParseByteNegativeValueThrowsOutOfRange) {
    ...
    ASSERT_THROW(Byte::parseByte(str), std::out_of_range);
  }
