...
namespace gtest_case
{
    ...
    TEST(ClassUtilTest, TemplateInstanceType)
    {
        ...
        EXPECT_EQ(common::ClassUtil::getTypeId(obj), "class std::vector<class std::list<int,class std::allocator<int> >,class std::allocator<class std::list<int,class std::allocator<int> > > >");
    }
}
