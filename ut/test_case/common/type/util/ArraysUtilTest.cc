...
TEST(ArraysUtilTest, AsList_ConvertsIntArrayToVector) {
  ...
  const std::vector<int> result = fox::ArraysUtil::asList(arr, 3);
...
TEST(ArraysUtilTest, CopyOf_ShrinksArraySize) {
  ...
  const std::vector<int> result = fox::ArraysUtil::copyOf(original, 5, 3);
  const std::vector expected = {1, 2, 3};
  EXPECT_EQ(result, expected);
}
...
TEST(ArraysUtilTest, CopyOf_ExpandsArraySizeWithDefaultValues) {
  ...
  const std::vector<int> result = fox::ArraysUtil::copyOf(original, 2, 4);
...
TEST(ArraysUtilTest, CopyOfRange_CopiesFullRange) {
  ...
  const std::vector<int> result = fox::ArraysUtil::copyOfRange(original, 0, 4);
...
TEST(ArraysUtilTest, CopyOfRange_CopiesPartialRange) {
  constexpr int original[] = {1, 2, 3, 4};
  const std::vector<int> result = fox::ArraysUtil::copyOfRange(original, 1, 3);
