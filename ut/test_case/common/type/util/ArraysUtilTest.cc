...
namespace gtest_case
{
    TEST(ArraysUtilTest, AsList_ConvertsIntArrayToVector)
    {
        ...
        const std::vector<int32_t> result = fox::ArraysUtil::asList(arr, 3);
    ...
    TEST(ArraysUtilTest, AsList_ConvertsStringArrayToVector)
    {
        ...
        const std::vector<std::string> result = fox::ArraysUtil::asList(arr, 2);
    ...
    {
        int32_t arr[] = {1, 3, 5, 7};
        fox::ArraysUtil::sort(arr, 4);
        const int32_t result = fox::ArraysUtil::binarySearch(arr, 4, 1);
        EXPECT_EQ(result, 0);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundInMiddle)
    {
        int32_t arr[] = {1, 3, 5, 7};
        fox::ArraysUtil::sort(arr, 4);
        const int32_t result = fox::ArraysUtil::binarySearch(arr, 4, 5);
        EXPECT_EQ(result, 2);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundAtEnd)
    {
        int32_t arr[] = {1, 3, 5, 7};
        fox::ArraysUtil::sort(arr, 4);
        const int32_t result = fox::ArraysUtil::binarySearch(arr, 4, 7);
        EXPECT_EQ(result, 3);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsNegativeOneWhenElementNotFound)
    {
        int32_t arr[] = {1, 3, 5, 7};
        fox::ArraysUtil::sort(arr, 4);
        const int32_t result = fox::ArraysUtil::binarySearch(arr, 4, 6);
        EXPECT_EQ(result, -1);
    }
    ...
    TEST(ArraysUtilTest, BinarySearchWithRange_ReturnsIndexWithinSpecifiedRange)
    {
        ...
        fox::ArraysUtil::sort(arr, 5);
        const int32_t result = fox::ArraysUtil::binarySearch(arr, 1, 4, 7);
        EXPECT_EQ(result, 3);
    }
    ...
    TEST(ArraysUtilTest, BinarySearchWithRange_ThrowsExceptionForInvalidRange)
    {
        ...
        EXPECT_THROW(fox::ArraysUtil::binarySearch(arr, 2, 1, 3), std::out_of_range);
    }

    TEST(ArraysUtilTest, CopyOf_ShrinksArraySize)
    {
        const int32_t original[] = {1, 2, 3, 4, 5};
        const std::vector<int32_t> result = fox::ArraysUtil::copyOf(original, 5, 3);
        const std::vector expected = {1, 2, 3};
        EXPECT_EQ(result, expected);
    }
    ...
    TEST(ArraysUtilTest, CopyOf_ExpandsArraySizeWithDefaultValues)
    {
        ...
        const std::vector<int32_t> result = fox::ArraysUtil::copyOf(original, 2, 4);
    ...
    TEST(ArraysUtilTest, CopyOfRange_CopiesFullRange)
    {
        ...
        const std::vector<int32_t> result = fox::ArraysUtil::copyOfRange(original, 0, 4);
    ...
    {
        constexpr int32_t original[] = {1, 2, 3, 4};
        const std::vector<int32_t> result = fox::ArraysUtil::copyOfRange(original, 1, 3);
    ...
    TEST(ArraysUtilTest, CopyOfRange_ThrowsExceptionForFromGreaterThanTo)
    {
        ...
        EXPECT_THROW(fox::ArraysUtil::copyOfRange(original, 3, 1), std::out_of_range);
    }
    ...
    TEST(ArraysUtilTest, Equals_ReturnsTrueForIdenticalArrays)
    {
        ...
        const bool result = fox::ArraysUtil::equals(a, 3, b, 3);
        EXPECT_TRUE(result);
    }
    ...
    TEST(ArraysUtilTest, Equals_ReturnsFalseForDifferentLengths)
    {
        ...
        constexpr int32_t b[] = {1, 2, 3};
        const bool result = fox::ArraysUtil::equals(a, 2, b, 3);
        EXPECT_FALSE(result);
    }
    ...
    {
        int32_t arr[] = {1, 2, 3};
        EXPECT_THROW(fox::ArraysUtil::sort(arr, 2, 1), std::out_of_range);
    }

    TEST(ArraysUtilTest, ToString_ReturnsSingleElementString)
    {
        constexpr int32_t arr[] = {42};
        const std::string result = fox::ArraysUtil::toString(arr, 1);
        EXPECT_EQ(result, "[42]");
    }
    ...
    {
        constexpr int32_t arr[] = {1, 2, 3};
        const std::string result = fox::ArraysUtil::toString(arr, 3);
