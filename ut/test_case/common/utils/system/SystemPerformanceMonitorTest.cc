...
namespace gtest_case
{
    ...
    {
        const auto [total_memory, available_memory, used_memory, memory_usage_percent] = common::SystemPerformanceMonitor::GetMemoryUsage();
    ...
    TEST(SystemPerformanceMonitorTest, GetCpuUsage_NormalInterval)
    {
        ...
        const auto [cpu_usage_percent] = common::SystemPerformanceMonitor::GetCpuUsage(interval);
