...
namespace gtest_case
{
    ...
    {
        common::ExponentialBackoff backoff(3, 100.0, 2.0, 50.0, 500.0, 12345u);
    ...
    {
        common::ExponentialBackoff backoff(3, 100.0, 2.0);
    ...
    {
        common::ExponentialBackoff backoff(2, 100.0, 2.0);
    ...
    {
        common::ExponentialBackoff backoff(3, 100.0, 2.0, 0.0, 1000.0, 12345u, true);
    ...
    {
        common::ExponentialBackoff backoff1(3, 100.0, 2.0, 0.0, 1000.0, 12345u);
        common::ExponentialBackoff backoff2(3, 100.0, 2.0, 0.0, 1000.0, 12345u);
