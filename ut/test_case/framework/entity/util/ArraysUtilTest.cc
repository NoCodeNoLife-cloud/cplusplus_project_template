...
namespace gtest_case
{
    TEST(ArraysUtilTest, AsList_ConvertsIntArrayToVector)
    {
        ...
        const std::vector<int> result = coco::ArraysUtil::asList(arr, 3);
    ...
    TEST(ArraysUtilTest, AsList_ConvertsStringArrayToVector)
    {
        ...
        const std::vector<std::string> result = coco::ArraysUtil::asList(arr, 2);
    ...
    {
        int arr[] = {1, 3, 5, 7};
        coco::ArraysUtil::sort(arr, 4);
        const int32_t result = coco::ArraysUtil::binarySearch(arr, 4, 1);
        EXPECT_EQ(result, 0);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundInMiddle)
    {
        int arr[] = {1, 3, 5, 7};
        coco::ArraysUtil::sort(arr, 4);
        const int32_t result = coco::ArraysUtil::binarySearch(arr, 4, 5);
        EXPECT_EQ(result, 2);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsIndexWhenElementFoundAtEnd)
    {
        int arr[] = {1, 3, 5, 7};
        coco::ArraysUtil::sort(arr, 4);
        const int32_t result = coco::ArraysUtil::binarySearch(arr, 4, 7);
        EXPECT_EQ(result, 3);
    }
    ...
    TEST(ArraysUtilTest, BinarySearch_ReturnsNegativeOneWhenElementNotFound)
    {
        int arr[] = {1, 3, 5, 7};
        coco::ArraysUtil::sort(arr, 4);
        const int32_t result = coco::ArraysUtil::binarySearch(arr, 4, 6);
        EXPECT_EQ(result, -1);
    }
    ...
    {
        int arr[] = {1, 3, 5, 7, 9};
        coco::ArraysUtil::sort(arr, 5);
        const int32_t result = coco::ArraysUtil::binarySearch(arr, 1, 4, 7);
        EXPECT_EQ(result, 3);
    }
    ...
    TEST(ArraysUtilTest, BinarySearchWithRange_ThrowsExceptionForInvalidRange)
    {
        ...
        EXPECT_THROW(coco::ArraysUtil::binarySearch(arr, 2, 1, 3), std::out_of_range);
    }

    TEST(ArraysUtilTest, CopyOf_ShrinksArraySize)
    {
        const int original[] = {1, 2, 3, 4, 5};
        const std::vector<int> result = coco::ArraysUtil::copyOf(original, 5, 3);
        const std::vector expected = {1, 2, 3};
        EXPECT_EQ(result, expected);
    }
    ...
    TEST(ArraysUtilTest, CopyOf_ExpandsArraySizeWithDefaultValues)
    {
        ...
        const std::vector<int> result = coco::ArraysUtil::copyOf(original, 2, 4);
    ...
    TEST(ArraysUtilTest, CopyOfRange_CopiesFullRange)
    {
        ...
        const std::vector<int> result = coco::ArraysUtil::copyOfRange(original, 0, 4);
    ...
    {
        constexpr int original[] = {1, 2, 3, 4};
        const std::vector<int> result = coco::ArraysUtil::copyOfRange(original, 1, 3);
    ...
    TEST(ArraysUtilTest, CopyOfRange_ThrowsExceptionForFromGreaterThanTo)
    {
        ...
        EXPECT_THROW(coco::ArraysUtil::copyOfRange(original, 3, 1), std::out_of_range);
    }
    ...
    TEST(ArraysUtilTest, Equals_ReturnsTrueForIdenticalArrays)
    {
        ...
        const bool result = coco::ArraysUtil::equals(a, 3, b, 3);
        EXPECT_TRUE(result);
    }
    ...
    TEST(ArraysUtilTest, Equals_ReturnsFalseForDifferentLengths)
    {
        constexpr int a[] = {1, 2};
        constexpr int b[] = {1, 2, 3};
        const bool result = coco::ArraysUtil::equals(a, 2, b, 3);
        EXPECT_FALSE(result);
    }
    ...
    {
        int arr[] = {1, 2, 3};
        EXPECT_THROW(coco::ArraysUtil::sort(arr, 2, 1), std::out_of_range);
    }

    TEST(ArraysUtilTest, ToString_ReturnsSingleElementString)
    {
        constexpr int arr[] = {42};
        const std::string result = coco::ArraysUtil::toString(arr, 1);
        EXPECT_EQ(result, "[42]");
    }
    ...
    {
        constexpr int arr[] = {1, 2, 3};
        const std::string result = coco::ArraysUtil::toString(arr, 3);
