...
namespace rpc
{
    ...
    {
    public:
        inline UserExistsRequest()
            : UserExistsRequest(nullptr)
        {
        }
        ...
        void operator delete(UserExistsRequest* msg,
        ...
        inline UserExistsRequest(const UserExistsRequest& from)
            : UserExistsRequest(nullptr, from)
        {
        }
        ...
        friend void swap(UserExistsRequest& a,
                         UserExistsRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        UserExistsRequest(::google::protobuf::Arena* arena,
                          const UserExistsRequest& from);

        UserExistsRequest(::google::protobuf::Arena* arena,
                          UserExistsRequest&& from) noexcept
    ...
    {
    public:
        inline ResetPasswordRequest()
            : ResetPasswordRequest(nullptr)
        {
        }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(ResetPasswordRequest* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        inline ResetPasswordRequest(const ResetPasswordRequest& from)
            : ResetPasswordRequest(nullptr, from)
        {
        }
        ...
        friend void swap(ResetPasswordRequest& a,
                         ResetPasswordRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        ResetPasswordRequest(::google::protobuf::Arena* arena,
                             const ResetPasswordRequest& from);

        ResetPasswordRequest(::google::protobuf::Arena* arena,
                             ResetPasswordRequest&& from) noexcept
    ...
    public:
        ...
        template <typename Arg_ = const std::string&, typename... Args_>
        void set_new_password(Arg_&& arg,
                              Args_... args);
    ...
    {
    public:
        inline RegisterUserRequest()
            : RegisterUserRequest(nullptr)
        {
        }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(RegisterUserRequest* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        inline RegisterUserRequest(const RegisterUserRequest& from)
            : RegisterUserRequest(nullptr, from)
        {
        }
        ...
        friend void swap(RegisterUserRequest& a,
                         RegisterUserRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        RegisterUserRequest(::google::protobuf::Arena* arena,
                            const RegisterUserRequest& from);

        RegisterUserRequest(::google::protobuf::Arena* arena,
                            RegisterUserRequest&& from) noexcept
    ...
    {
    public:
        inline DeleteUserRequest()
            : DeleteUserRequest(nullptr)
        {
        }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(DeleteUserRequest* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        friend void swap(DeleteUserRequest& a,
                         DeleteUserRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        DeleteUserRequest(::google::protobuf::Arena* arena,
                          const DeleteUserRequest& from);

        DeleteUserRequest(::google::protobuf::Arena* arena,
                          DeleteUserRequest&& from) noexcept
    ...
    {
    public:
        inline ChangePasswordRequest()
            : ChangePasswordRequest(nullptr)
        {
        }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(ChangePasswordRequest* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        friend void swap(ChangePasswordRequest& a,
                         ChangePasswordRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        ChangePasswordRequest(::google::protobuf::Arena* arena,
                              const ChangePasswordRequest& from);

        ChangePasswordRequest(::google::protobuf::Arena* arena,
                              ChangePasswordRequest&& from) noexcept
    ...
    public:
        ...
        template <typename Arg_ = const std::string&, typename... Args_>
        void set_current_password(Arg_&& arg,
                                  Args_... args);
    ...
    {
    public:
        inline AuthenticateUserRequest()
            : AuthenticateUserRequest(nullptr)
        {
        }
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(AuthenticateUserRequest* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        inline AuthenticateUserRequest(const AuthenticateUserRequest& from)
            : AuthenticateUserRequest(nullptr, from)
        {
        }
        ...
        friend void swap(AuthenticateUserRequest& a,
                         AuthenticateUserRequest& b) { a.Swap(&b); }
    ...
    protected:
        ...
        AuthenticateUserRequest(::google::protobuf::Arena* arena,
                                const AuthenticateUserRequest& from);

        AuthenticateUserRequest(::google::protobuf::Arena* arena,
                                AuthenticateUserRequest&& from) noexcept
    ...
    public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        void operator delete(AuthResponse* msg,
                             std::destroying_delete_t)
        {
            SharedDtor(*msg);
        ...
        friend void swap(AuthResponse& a,
                         AuthResponse& b) { a.Swap(&b); }
    ...
    protected:
        ...
        AuthResponse(::google::protobuf::Arena* arena,
                     const AuthResponse& from);

        AuthResponse(::google::protobuf::Arena* arena,
                     AuthResponse&& from) noexcept
            : AuthResponse(arena)
        {
            *this = ::std::move(from);
        }
