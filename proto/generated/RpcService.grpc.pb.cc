...
std::unique_ptr<RpcService::Stub> RpcService::NewStub(
    const std::shared_ptr< ::grpc::ChannelInterface>& channel,
    const ::grpc::StubOptions& options) {
  (void)options;
  std::unique_ptr<RpcService::Stub> stub(
      new RpcService::Stub(channel, options));
  return stub;
}

RpcService::Stub::Stub(
    const std::shared_ptr< ::grpc::ChannelInterface>& channel,
    const ::grpc::StubOptions& options)
    : channel_(channel),
      rpcmethod_Send_(RpcService_method_names[0], options.suffix_for_stats(),
...
void RpcService::Stub::async::Send(::grpc::ClientContext* context,
  ...
  ::grpc::internal::CallbackUnaryCall<
      ::rpc::MessageRequest, ::rpc::MessageResponse,
      ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
      stub_->channel_.get(), stub_->rpcmethod_Send_, context, request, response,
      std::move(f));
}
...
RpcService::Stub::PrepareAsyncSendRaw(::grpc::ClientContext* context,
  ...
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create<
      ::rpc::MessageResponse, ::rpc::MessageRequest,
      ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
      channel_.get(), cq, rpcmethod_Send_, context, request);
}

::grpc::ClientAsyncResponseReader< ::rpc::MessageResponse>*
RpcService::Stub::AsyncSendRaw(::grpc::ClientContext* context,
                               const ::rpc::MessageRequest& request,
                               ::grpc::CompletionQueue* cq) {
...
RpcService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler<
          RpcService::Service, ::rpc::MessageRequest, ::rpc::MessageResponse,
          ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RpcService::Service* service, ::grpc::ServerContext* ctx,
             const ::rpc::MessageRequest* req, ::rpc::MessageResponse* resp) {
...
::grpc::Status RpcService::Service::Send(::grpc::ServerContext* context,
                                         const ::rpc::MessageRequest* request,
                                         ::rpc::MessageResponse* response) {
  (void)context;
  (void)request;
