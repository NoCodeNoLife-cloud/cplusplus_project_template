...
namespace rpc
{
    ...
    ::grpc::Status RpcService::Stub::RegisterUser(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::RegisterUser(::grpc::ClientContext* context,
                                               const ::rpc::RegisterUserRequest* request,
                                               ::rpc::AuthResponse* response,
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncRegisterUserRaw(::grpc::ClientContext* context,
                                                                                                          const ::rpc::RegisterUserRequest& request,
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncRegisterUserRaw(::grpc::ClientContext* context,
                                                                                                   const ::rpc::RegisterUserRequest& request,
                                                                                                   ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Stub::AuthenticateUser(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::AuthenticateUser(::grpc::ClientContext* context,
                                                   const ::rpc::AuthenticateUserRequest* request,
                                                   ::rpc::AuthResponse* response,
                                                   std::function<void(::grpc::Status)> f)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncAuthenticateUserRaw(::grpc::ClientContext* context,
                                                                                                              const ::rpc::AuthenticateUserRequest& request,
                                                                                                              ::grpc::CompletionQueue* cq)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncAuthenticateUserRaw(::grpc::ClientContext* context,
                                                                                                       const ::rpc::AuthenticateUserRequest& request,
                                                                                                       ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Stub::ChangePassword(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::ChangePassword(::grpc::ClientContext* context,
                                                 const ::rpc::ChangePasswordRequest* request,
                                                 ::rpc::AuthResponse* response,
                                                 std::function<void(::grpc::Status)> f)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncChangePasswordRaw(::grpc::ClientContext* context,
                                                                                                            const ::rpc::ChangePasswordRequest& request,
                                                                                                            ::grpc::CompletionQueue* cq)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncChangePasswordRaw(::grpc::ClientContext* context,
                                                                                                     const ::rpc::ChangePasswordRequest& request,
                                                                                                     ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Stub::ResetPassword(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::ResetPassword(::grpc::ClientContext* context,
                                                const ::rpc::ResetPasswordRequest* request,
                                                ::rpc::AuthResponse* response,
                                                std::function<void(::grpc::Status)> f)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncResetPasswordRaw(::grpc::ClientContext* context,
                                                                                                           const ::rpc::ResetPasswordRequest& request,
                                                                                                           ::grpc::CompletionQueue* cq)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncResetPasswordRaw(::grpc::ClientContext* context,
                                                                                                    const ::rpc::ResetPasswordRequest& request,
                                                                                                    ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Stub::DeleteUser(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::DeleteUser(::grpc::ClientContext* context,
                                             const ::rpc::DeleteUserRequest* request,
                                             ::rpc::AuthResponse* response,
                                             std::function<void(::grpc::Status)> f)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncDeleteUserRaw(::grpc::ClientContext* context,
                                                                                                        const ::rpc::DeleteUserRequest& request,
                                                                                                        ::grpc::CompletionQueue* cq)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncDeleteUserRaw(::grpc::ClientContext* context,
                                                                                                 const ::rpc::DeleteUserRequest& request,
                                                                                                 ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Stub::UserExists(::grpc::ClientContext* context,
    ...
    void RpcService::Stub::async::UserExists(::grpc::ClientContext* context,
                                             const ::rpc::UserExistsRequest* request,
                                             ::rpc::AuthResponse* response,
                                             std::function<void(::grpc::Status)> f)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::PrepareAsyncUserExistsRaw(::grpc::ClientContext* context,
                                                                                                        const ::rpc::UserExistsRequest& request,
                                                                                                        ::grpc::CompletionQueue* cq)
    {
    ...
    ::grpc::ClientAsyncResponseReader<::rpc::AuthResponse>* RpcService::Stub::AsyncUserExistsRaw(::grpc::ClientContext* context,
                                                                                                 const ::rpc::UserExistsRequest& request,
                                                                                                 ::grpc::CompletionQueue* cq)
    {
        auto* result =
    ...
    ::grpc::Status RpcService::Service::RegisterUser(::grpc::ServerContext* context,
                                                     const ::rpc::RegisterUserRequest* request,
                                                     ::rpc::AuthResponse* response)
    {
        (void)context;
    ...
    ::grpc::Status RpcService::Service::AuthenticateUser(::grpc::ServerContext* context,
                                                         const ::rpc::AuthenticateUserRequest* request,
                                                         ::rpc::AuthResponse* response)
    {
        (void)context;
    ...
    ::grpc::Status RpcService::Service::ChangePassword(::grpc::ServerContext* context,
                                                       const ::rpc::ChangePasswordRequest* request,
                                                       ::rpc::AuthResponse* response)
    {
        (void)context;
    ...
    ::grpc::Status RpcService::Service::ResetPassword(::grpc::ServerContext* context,
                                                      const ::rpc::ResetPasswordRequest* request,
                                                      ::rpc::AuthResponse* response)
    {
        (void)context;
    ...
    ::grpc::Status RpcService::Service::DeleteUser(::grpc::ServerContext* context,
                                                   const ::rpc::DeleteUserRequest* request,
                                                   ::rpc::AuthResponse* response)
    {
        (void)context;
    ...
    ::grpc::Status RpcService::Service::UserExists(::grpc::ServerContext* context,
                                                   const ::rpc::UserExistsRequest* request,
                                                   ::rpc::AuthResponse* response)
    {
        (void)context;
